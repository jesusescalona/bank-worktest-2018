...
/**
 * Defines the business logic for performing transfers between accounts.
 */
public interface TransferService {
    /**
     * Executes a balanced, multi-legged monetary transaction as a single unit of work.
     *
     * @param transfer a transfer request describing the transactions legs
     ...
     * @throws InfrastructureException on non-recoverable infrastructure errors
     */
    List<Transaction> findTransactionByAccountRef(String accountRef);
